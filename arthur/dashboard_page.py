...
class DashboardPage:
    def __init__(self, root, app):
        ...
        self.result_label = tk.Label(self.frame, text="Résultats du scan", fg="white", bg="#1E1E2D", font=("Arial", 18, "bold"))
        ...
        self.scan_time_label.pack(pady=10)  # Espacement vertical
    ...
    def show_results(self, machine_info):
        ...
        self.scan_time_label.config(text=f"Dernier scan lancé le: {scan_time}")
        ...
        for ip, open_ports, service_info, vulnerabilities in machine_info:
            ...
            if not open_ports:
                ...
                no_ports_label.pack(anchor="w", pady=5)
            else:
    ...
    def display_port_details(self, port, service_info, vulnerabilities):
        ...
        port_label.pack(anchor="w", pady=5)
    ...
    def display_ports(self, open_ports, service_info, vulnerabilities):
        ...
        if open_ports:
            ...
            ports_label.pack(anchor="w", pady=5)
